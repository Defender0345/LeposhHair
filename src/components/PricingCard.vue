<template>
  <div class="cards">
    ...
    <div class="card">
      <span class="header">Brazilian</span>
      <div class="container">
        <div class="services">
          <p>Short</p>
          <p>Medium</p>
...
.cards {
  ...
  .card {
    ...
    width: 375px;
    margin: 1em;
    background: linear-gradient(to right, rgb(105, 105, 105), $primary);
    border-radius: 1em;
